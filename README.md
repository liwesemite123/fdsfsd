...
## 🆕 Новое: Leboncoin Parser

Добавлен мощный парсер для французского сайта объявлений leboncoin.fr:
- ✅ Парсинг объявлений с поддержкой прокси
- ✅ Выбор категорий для парсинга
- ✅ Извлечение данных продавца (продажи, отзывы, рейтинг)
- ✅ Фильтрация по параметрам продавца
- ✅ Асинхронная обработка для высокой скорости

📖 **[Подробная документация по Leboncoin Parser](LEBONCOIN_README.md)**

## 🎯 Основные возможности (Poshmark)
